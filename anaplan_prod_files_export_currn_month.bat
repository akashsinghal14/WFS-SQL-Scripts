...
set Operation=-export "Attrition Calculation - Current Month.txt" -execute -get "C:/Users/msazureuser/Desktop/Anaplan/Anaplan 2018/AutomateProcess/Current Month.txt"
