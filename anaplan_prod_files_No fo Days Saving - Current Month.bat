...
set Operation=-export "Budgeted Positions - No fo Days Saving - Current Month.txt" -execute -get "C:/Users/msazureuser/Desktop/Anaplan/Anaplan 2018/AutomateProcess/NofoDaysSavingCurrentMonth.txt"
