...
set Operation=-export "Current Month - Winning Mix Calculation.txt" -execute -get "C:/Users/msazureuser/Desktop/Anaplan/Anaplan 2018/AutomateProcess/Winning Mix Calculation.txt"
